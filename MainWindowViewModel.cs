	...
	public class MainWindowViewModel : BaseViewModel
	{
		...
		public void InitializeCommandDescriptions()
		{
			CommandDescriptions = new ObservableRangeCollection<CommandDescription>()
			{
				...
				new CommandDescription() { Name="addi", Example="addi $t1 20 $t1 or add 20 10 $t1", Parameter1="Source Register/Immediate", Parameter2="Source Register/Immediate", Parameter3="Destination Register", Description="Add two registers/immediates together and output to destination register" },
